...
describe EdgesController do
  ...
  describe "GET index" do
    it "assigns all edges as @edges" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created edge" do
        post :create, :edge => valid_attributes
        response.should redirect_to(Edge.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested edge" do
        ...
        Edge.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the edges list" do
      edge = Edge.create! valid_attributes
      delete :destroy, :id => edge.id.to_s
      response.should redirect_to(edges_url)
    end
  end
