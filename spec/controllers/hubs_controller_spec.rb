  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hub" do
        ...
        put :update, :id => hub.id, :hub => {'these' => 'params'}
      end

      it "assigns the requested hub as @hub" do
        hub = Hub.create! valid_attributes
        put :update, :id => hub.id, :hub => valid_attributes
        assigns(:hub).should eq(hub)
      end
